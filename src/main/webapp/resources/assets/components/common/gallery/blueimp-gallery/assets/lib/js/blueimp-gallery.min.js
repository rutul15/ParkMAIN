!function () {
    ...
    return t.extend(e.prototype, {
        ...
        support: function (e) {
            var i, s, n, o = {touch: void 0 !== window.ontouchstart || window.DocumentTouch && document instanceof DocumentTouch}, l = {
                webkitTransition: {
                ...
                document.body.appendChild(e), s && (i = s.name.slice(0, -9) + "ransform", void 0 !== e.style[i] && (e.style[i] = "translateZ(0)", n = window.getComputedStyle(e).getPropertyValue(s.prefix + "transform"), o.transform = {
                    ...
                    translate: !0,
                    translateZ: !!n && "none" !== n
                })), void 0 !== e.style.backgroundSize && (e.style.backgroundSize = "contain", o.backgroundSize = {contain: "contain" === window.getComputedStyle(e).getPropertyValue("background-size")}), document.body.removeChild(e)
            };
    ...
    return t.extend(e.prototype.options, {
    ...
    }), e.prototype.videoFactory = function (e, i) {
        var s, n, o, l, r, a = this, h = this.options, d = this.elementPrototype.cloneNode(!1), c = t(d), u = [{
            type: "error",
            target: d
        }], p = document.createElement("video"), m = this.getItemProperty(e, h.urlProperty), f = this.getItemProperty(e, h.typeProperty), g = this.getItemProperty(e, h.titleProperty), v = this.getItemProperty(e, h.videoPosterProperty), y = this.getItemProperty(e, h.videoSourcesProperty);
        if (c.addClass(h.videoContentClass), g && (d.title = g), p.canPlayType)if (m && f && p.canPlayType(f))p.src = m; else if (y)for ("string" == typeof y && (y = t.parseJSON(y)); y && y.length;)if (n = y.shift(), m = this.getItemProperty(n, h.urlProperty), f = this.getItemProperty(n, h.typeProperty), m && f && p.canPlayType(f)) {
            p.src = m;
            break
        }
        return v && (p.setAttribute("poster", v), s = this.imagePrototype.cloneNode(!1), t(s).addClass(h.toggleClass), s.src = v, s.draggable = !1, d.appendChild(s)), o = document.createElement("a"), o.setAttribute("target", "_blank"), o.setAttribute("download", g), o.href = m, p.src && (p.controls = !0, t(p).on("error", function () {
            a.setTimeout(i, u)
        }).on("pause", function () {
        ...
        }), d.appendChild(p)), d.appendChild(o), this.setTimeout(i, [{type: "load", target: d}]), d
    }, e
});