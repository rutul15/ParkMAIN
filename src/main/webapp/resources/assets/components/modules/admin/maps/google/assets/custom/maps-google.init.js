    ...
    if ($('#google-map-filters').length) {
        ...
        $('#google-map-filters').gmap({'disableDefaultUI': true}).bind('init', function (evt, map) {
            ...
            for (i = 0; i < 100; i++) {
                ...
                $('#google-map-filters').gmap('addMarker', {
            ...
            $('input:checkbox').click(function () {
                ...
                if (filters.length > 0) {
                    $('#google-map-filters').gmap('find', 'markers', {
                        'property': 'tags',
                        'value': filters,
                        'operator': 'OR'
                    ...
                    $.each(data.markers, function (i, marker) {
                        setTimeout(function () {
                                mfsr.gmap('addMarker',
                                    ...
                                    .click(function () {
                                        mfsr.gmap('openInfoWindow', {
                                            'content': msfr_info(marker),
                                            'maxWidth': mfsr_info_width
                                        }, this);
                                    });
