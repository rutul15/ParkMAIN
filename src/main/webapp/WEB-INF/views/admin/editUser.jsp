...
<div class="container-fluid menu-hidden">
    ...
    <div id="content">
        ...
        <div class="innerLR">
            ...
            <div class="innerLR">
                <!-- Form -->
                <form:form class="form-horizontal margin-none" action="/admin/users/editPage/" method="post"
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body innerAll inner-2x">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" value="update"><i
                                        class="fa fa-check-circle"></i> Update
                                </button>
                                <a href="/admin/users">
                                    <button type="button" class="btn btn-default" value="cancel"><i
