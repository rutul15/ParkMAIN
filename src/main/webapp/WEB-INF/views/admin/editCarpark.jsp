...
<div class="container-fluid menu-hidden">
    ...
    <div id="content">
        ...
        <div class="innerLR">
            ...
            <div class="innerLR">
                <!-- Form -->
                <form:form class="form-horizontal margin-none" action="/admin/carparks/editPage" method="post"
                           commandName="carpark" autocomplete="off">
                    <!-- Widget -->
                    <div class="widget">
                        <!-- Widget heading -->
                        <div class="widget-head">
                            <h4 class="heading">Edit Carpark</h4>
                        </div>
                        <!-- // Widget heading END -->
                        <div class="widget-body innerAll inner-2x">
                            ...
                            <div class="row innerLR">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <form:hidden path="id" value="${carpark.id}"></form:hidden>
                            ...
                            <div class="row innerLR">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <!-- Group -->
                                    <div class="form-group">
                                        <form:label class="col-md-4 control-label" path="spacesavailable"
                                                    for="spacesavailable"></form:label>
                                        <div class="col-md-8">
                                            <form:input disabled="true" path="spacesavailable" class="form-control"
                                                        id="spacesavailable"
                                                        name="spacesavailable" type="text"/>
                                        </div>
                                    </div>
                                    <!-- // Group END -->
